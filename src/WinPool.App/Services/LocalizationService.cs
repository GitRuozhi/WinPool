...
public sealed class LocalizationService : ObservableObject
{
    ...
    private static readonly IReadOnlyDictionary<string, (string Zh, string En)> Texts =
        new Dictionary<string, (string Zh, string En)>(StringComparer.Ordinal)
        {
            ...
            ["CopyCurrentValue"] = ("复制当前值", "Copy current value"),
            ["CopyGroup"] = ("复制整组", "Copy group"),
            ["RawFields"] = ("原始字段", "Raw fields"),
            ["RawFieldsUnavailable"] = ("此组没有可显示的原始字段。", "No raw fields are available for this group."),
            ["NoOriginalSource"] = ("无原始来源", "No original source."),
            ...
            ["UnallocatedLayer"] = ("未划层", "Unallocated layer"),
            ["VirtualDisks"] = ("虚拟磁盘", "Virtual disks"),
            ["OperationArea"] = ("操作区", "Operations"),
            ["TopologyArea"] = ("完整存储拓扑", "Complete storage topology"),
            ["Scanning"] = ("采集中…", "Collecting inventory…"),
            ["InventoryAutomaticStorage"] = ("自动采集：存储系统", "Automatic collection: storage system"),
            ["InventoryAutomaticHardware"] = ("自动采集：完整硬件", "Automatic collection: full hardware"),
            ["ConnectingAgent"] = ("正在连接后台服务…", "Connecting to the tray agent…"),
            ["LoadingWorkspace"] = ("正在加载工作区…", "Loading the workspace…"),
            ["ScanComplete"] = ("采集成功", "Collection succeeded"),
            ...
            ["Members"] = ("成员", "Members"),
            ["Membership"] = ("归属", "Membership"),
            ["MembershipUnknown"] = ("归属未知", "Membership unknown"),
            ["Objects"] = ("对象", "Objects"),
            ...
            ["ScanFailed"] = ("采集失败；已保留上一次成功结果。", "Collection failed; the last successful result is preserved."),
            ...
            ["SyntheticStoragePool"] = ("模拟池", "Synthetic pool"),
            ["SyntheticStorageTier"] = ("模拟层", "Synthetic tier"),
            ["OtherDiskPool"] = ("其它磁盘池", "Other disk pool"),
            ["NetworkDiskPool"] = ("网络磁盘池", "Network disk pool"),
            ...
            ["RemovePageFileMessage"] = ("退出前将移除该磁盘上的页面文件。确定继续？", "The page file on this disk will be removed before it leaves the tier. Continue?"),
            ["RemoveCrashDumpTitle"] = ("移除崩溃转储", "Remove crash dump"),
            ...
            ["Undo"] = ("撤销", "Undo"),
            ["Redo"] = ("重做", "Redo"),
            ["DiscardAll"] = ("放弃结构修改", "Discard structure changes"),
            ["ApplyAll"] = ("应用结构修改", "Apply structure changes"),
            ["CreatePool"] = ("创建池", "Create pool"),
            ["RetireDisk"] = ("退役物理磁盘", "Retire physical disk"),
            ["HotSpareDisk"] = ("热备物理磁盘", "Hot-spare physical disk"),
            ["RetiredLayer"] = ("退役层", "Retired layer"),
            ["HotSpareLayer"] = ("热备层", "Hot spare layer"),
            ["SavePoolProperties"] = ("保存池属性修改", "Save pool properties"),
            ["PoolSection"] = ("池", "Pool"),
            ["VolumeName"] = ("卷名", "Volume name"),
            ["AutoCreateVirtualDisk"] = ("自动创建虚拟磁盘", "Auto-create virtual disk"),
            ["ResetRecommended"] = ("恢复推荐", "Restore recommended"),
