...
current_work_package: WP5
next_action: 审查白名单暂存内容、确认远端祖先关系并推送 main
branch: main
remote: origin
...
| WP5 自动门与推送 | in_progress | restore、455/455 test、Release build 0/0、漏洞检查、链接/结构检查均通过 | 显式白名单暂存、祖先检查、push |
