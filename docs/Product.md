...
本文件是当前产品行为、边界和路线的中文权威。2026-09-10 用户决定已覆盖相冲突的历史设计。当前实现为 V0.50；阶段结果见 [Plan](Plan.md)，V0.49 计划与未验证项见 [归档](Archive/V0.49/README.md)。已知限制见 [CHANGELOG](CHANGELOG.md)。
