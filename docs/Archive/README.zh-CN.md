...
平台计划已归档到 `V0.44`。活动计划是 [`docs/Plan.md`](../Plan.md)（共享
runtime staging；尚未开始实施；产品版本仍为 V0.44）。
...
| [`V0.44-shared-staging-draft/`](V0.44-shared-staging-draft/) | 归档源记录；已被活动 Plan 替代 | 2026-09-01 | V0.44 非正式跟进 | 对齐实验之后的 App/Agent 共享 runtime staging 英文草稿；已被 `docs/Plan.md` 替代 |
