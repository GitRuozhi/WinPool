...
到 `V0.43`。活动计划是 [`docs/Plan.md`](../Plan.md)（V0.44；尚未开始实施）。
...
| [`V0.44-draft/`](V0.44-draft/) | 归档源记录；已被活动 Plan 替代 | 2026-09-01 | V0.44 手写输入 | 开发者手写的平台升级与发行瘦身中文草案；已被 `docs/Plan.md` 替代 |
