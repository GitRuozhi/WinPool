...
| [`V0.32/`](V0.32/) | accepted; manual cases unverified | 2026-08-10 | V0.32; remote commit pending | Final V0.31 correction state and the user's V0.32 source-checkpoint decision |
