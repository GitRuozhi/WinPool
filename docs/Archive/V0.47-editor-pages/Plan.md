...
**Freeze annotation (2026-09-07):** The developer closed this Edit-page split
stage. Navigation PE1–PE2 landed in `ca03c69` and related commits. Later PE3–PE7
rows in this file mixed in control-spec work that was not this stage; that work
is the next active Plan. This file is frozen as written.

## 0. Status, authority, and baseline

- **Plan status:** closed by the developer 2026-09-07; split-page work landed;
  native PE8 unverified; frozen here
- **Created:** 2026-09-07
