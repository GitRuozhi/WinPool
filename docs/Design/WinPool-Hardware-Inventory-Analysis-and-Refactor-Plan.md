...
> 定位更新：2026-09-10。设计储备，未纳入 V0.48；实施前由开发者与 Agent 重新讨论和调整。
> 下文保留原方案内容，不代表当前功能、已确认版本计划或实施授权。
> 待重新核对：完整硬件页的产品范围、两种采集动作的必要性、模型重构后的接口与缓存。
> 状态与采纳规则见 [设计索引](README.md)。
...
- 采集值保持原值；2026-09-15 已删除隐私开关和 sanitizer。
