...
- **Plan status:** proposed; implementation not started
- **Created:** 2026-09-03
- **Updated:** 2026-09-03
- **Baseline commit:** `7bd21f283b8c676af8a278317973d2a4dd20e280`
- **Working branch:** `main`
...
The currently implemented Edit-page Plan must be frozen under `docs/Archive`
with its truthful final state before this Plan becomes the active
`docs/Plan.md`. The Archive index and matching Chinese reading copies must be
updated in the same documentation work item.
...
remaining width = 333 px

A extra = 333 × 100 / 300 = 111 px
B extra = 333 × 200 / 300 = 222 px
...
2. all references have been migrated;
3. Manage regression tests pass;
4. Edit-upper and Edit-lower targeted layout tests pass.
...
| Id | Work |
| --- | --- |
| TL0 | Documentation rollover: archive the completed previous Plan and reading copy, update Archive index/copy, install this Plan and matching `Plan.zh-CN.md` |
...
| TL3 | Remove Edit-page dependence on a shared Manage viewport-width state |
...
minimum width: 112 px each
remaining width: 333 px
expected final widths: 223 px, 334 px
```
...
- the 100 GiB / 200 GiB / 333 px example produces 223 px / 334 px;
